...
class Plot_Reproduce_Performance():
    def __init__(self, DIR, n_img_x=8, n_img_y=8, img_w=IMAGE_SIZE, img_h=IMAGE_SIZE, resize_factor=1.0):
        self.DIR = DIR
...
class Plot_Manifold_Learning_Result():
    def __init__(self, DIR, n_img_x=20, n_img_y=20, img_w=IMAGE_SIZE, img_h=IMAGE_SIZE, resize_factor=1.0, z_range=4):
        self.DIR = DIR
